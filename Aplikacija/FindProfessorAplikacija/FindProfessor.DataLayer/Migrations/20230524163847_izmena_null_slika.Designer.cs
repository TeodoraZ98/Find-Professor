...
namespace FindProfessor.DataLayer.Migrations
{
    ...
    [Migration("20230524163847_izmena_null_slika")]
    partial class izmena_null_slika
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FindProfessor.Models.Termin", b =>
                {
                    ...
                    b.Property<int>("ProfesorKorisnikID")
                        .HasColumnType("int");

                    b.HasKey("TerminId");

                    b.HasIndex("ProfesorKorisnikID");
            ...
            modelBuilder.Entity("FindProfessor.Models.Termin", b =>
                {
                    b.HasOne("FindProfessor.Models.Profesor", "Profesor")
                        .WithMany("Termini")
                        .HasForeignKey("ProfesorKorisnikID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FindProfessor.Models.Admin", b =>
                {
                    b.HasOne("FindProfessor.Models.Korisnik", null)
                        .WithOne()
                        .HasForeignKey("FindProfessor.Models.Admin", "KorisnikID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("FindProfessor.Models.Profesor", b =>
                {
                    b.HasOne("FindProfessor.Models.Korisnik", null)
                        .WithOne()
                        .HasForeignKey("FindProfessor.Models.Profesor", "KorisnikID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("FindProfessor.Models.Ucenik", b =>
                {
                    b.HasOne("FindProfessor.Models.Korisnik", null)
                        .WithOne()
                        .HasForeignKey("FindProfessor.Models.Ucenik", "KorisnikID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
