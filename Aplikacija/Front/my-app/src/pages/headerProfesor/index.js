...
import { profilProfesorRoute, profesorTerminiRoute } from "../../router/routes";
...
const NavBarProfesor = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      const TOKEN = localStorage.getItem('token')
      await Axios.get('https://localhost:7138/Profesor/vratiProfesoraPoId?id=' + logovan.id,
        {
  ...
  const renderMenu = (
    ...
    >
      <MenuItem src={'https://localhost:7138/StaticFiles/' + slika} href='/profesorProfilRoute'>
        <IconButton href='/profesorProfilRoute'>
          Profil
        </IconButton>
  ...
  const renderMobileMenu = (
    ...
    >
      <MenuItem src={'https://localhost:7138/StaticFiles/' + slika}>
        <IconButton
          size="large"
          ...
          aria-haspopup="true"
          color="inherit"
          src={'https://localhost:7138/StaticFiles/' + slika}
        >
          <Avatar sx={{ bgcolor: red[500] }} aria-label="recipe" src={'https://localhost:7138/StaticFiles/' + slika}>
          </Avatar>
        </IconButton>
      </MenuItem>
      <MenuItem onClick={() => navigate(profilProfesorRoute)}>
        <IconButton
          size="large"
          color="inherit"
        >
      ...
      <MenuItem onClick={() => navigate(profesorTerminiRoute)}>
        <IconButton
          size="large"
          color="inherit"
        >
      ...
      <MenuItem onClick={() => { navigate('/profesorZahteviRoute') }} >
        <IconButton
          size="large"
          color="inherit"
        >
